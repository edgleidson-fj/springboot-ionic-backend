...
//Classe criada para custumizar a validaÁ„o de Email, na atualizaÁ„o do Cliente.
public class ClienteUpdateValidacao implements ConstraintValidator<ClienteUpdate, ClienteDTO> {

	@Autowired
	private HttpServletRequest request; //Requisi√ß√£o Web.
	@Autowired
	...
	public boolean isValid(ClienteDTO objDto, ConstraintValidatorContext context) {
		...
		//MÈtodo para pegar o ID do Cliente que est„o° sendo atualizado, via URI.
		//Map<Chave, Valor>
		...
		//Email - Checando o ID do cliente na atualiza√ß√£o.
		Cliente aux = clienteRepository.findByEmail(objDto.getEmail());
		if(aux != null && !aux.getId().equals(uriID)) {
			lista.add(new MensagemDoCampo("email", "Email j√° existente."));
		}
