...
public class AutenticacaoService {
	...
	private char caracteresAleatorio() {
		int opcao = aleatorio.nextInt(3);
		
		if(opcao == 0) { // Gera um dígito.
			return (char) (aleatorio.nextInt(10) + 48); //Caractere de 0-9.
		}else
			if(opcao == 1) { // Gera letra maiúscula.
				return (char) (aleatorio.nextInt(26) + 65); //Caractere de A-Z.
			}else { // Gera letra minúscula.
				return (char) (aleatorio.nextInt(26) + 97); //Caractere de a-z.
			}		
	}
